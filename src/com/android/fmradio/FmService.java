...
public class FmService extends Service implements FmRecorder.OnRecorderStateChangedListener {
    ...
    private class FmServiceBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ((SOUND_POWER_DOWN_MSG.equals(action) && CMDPAUSE.equals(command))) {
                ...
                switchAntennaAsync(mValueHeadSetPlug);//notifyActivityStateChanged
                Log.e(TAG,"mValueHeadSetPlug="+mValueHeadSetPlug);
    ...
    private boolean powerUp(float frequency) {
        ...
        // power up
        if (!mIsDeviceOpen) {
            boolean b=openDevice();
            Log.e(TAG, "powerUp: openDevice()="+b);
        }
    ...
    public void onCreate() {
        ...
        boolean b=openDevice();
        Log.e(TAG, "onCreate: openDevice()="+b);
        ...
        Log.e(TAG,"mAudioManager.isWiredHeadsetOn()="+mAudioManager.isWiredHeadsetOn());
    }
...
//                    deviceEarphoneCount++;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case FmListener.MSGID_SEEK_FINISHED:
                    ...
                    Log.e(TAG,"seekStation="+seekStation);
    ...
    private void handlePowerUp(Bundle bundle) {
        ...
        if (powerUp(curFrequency)) {
            Log.d(TAG, "powerUp(curFrequency)=true");
