...
public class FmFavoriteActivity extends Activity {
    ...
    private ListView mListView = null; // list view
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mListView.setAdapter(mMyAdapter); // set adapter
        ...
        switch (item.getItemId()) {
            ...
            case R.id.fm_station_list_refresh:
                if (null != mService) {
                    ...
                    mListView.setEmptyView(mSearchTips);
    ...
    class MyFavoriteAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (mCursor != null && mCursor.moveToFirst()) {
                ...
                viewHolder.mStationNameView.setText("FM");
                viewHolder.mStationRdsView.setText("");
                if (0 == isFavorite) {
                    viewHolder.mStationTypeView.setImageResource(R.drawable.icon_btn_favorite_off_list);
                    viewHolder.mStationTypeView.setColorFilter(null);
                    viewHolder.mStationTypeView.setAlpha(1.0f);
                } else {
                    viewHolder.mStationTypeView.setImageResource(R.drawable.icon_btn_favorite_on_list);
                    viewHolder.mStationTypeView.setColorFilter(null);
                    viewHolder.mStationTypeView.setAlpha(1.0f);
                }
